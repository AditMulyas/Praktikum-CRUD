...
class Pegawai_Model extends CI_Model {
		...
		{
			$this->db->select("id,nama,nip, alamat, DATE_FORMAT(tanggalLahir,'%d-%m-%Y') as tanggalLahir");
		...
		{
			$object = array('nama' => $this->input->post('nama'), 'nip' => $this->input->post('nip'), 'alamat' => $this->input->post('alamat'), 'tanggalLahir' => $this->input->post('tanggalLahir'),);
		...
		{
			$data = array('nama' => $this->input->post('nama'), 'nip' => $this->input->post('nip'), 'alamat' => $this->input->post('alamat'), 'tanggalLahir' => $this->input->post('tanggalLahir'),);
			$this->db->where('id', $id);
