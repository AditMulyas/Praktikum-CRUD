							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										...
										<li class="active"><a href="<?php echo site_url('pegawai/create') ?>">Create New Data</a></li>
									</ul>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-success">Update</a>
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-success">Delete</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
